	...
	static object GetPropertyValueGeneric(SerializedProperty property)
	{
		...
		if(iterator.Next(true))
		{
			...
			do
			{
				...
				if (!dict.ContainsKey(name)) dict.Add(name, value);
				else Debug.LogError("Dictionary already contains key: " + name);
...
[CustomPropertyDrawer(typeof(PlayerController.ColliderStates))]
